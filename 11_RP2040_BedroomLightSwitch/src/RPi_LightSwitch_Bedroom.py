...
# 85AF4        | R1=xxx Chip Temperature [deg C]
# 85AF4 255    | Switch Light ON (Pin3)
# 85AF4 0      | Switch Light OFF (Pin3)
...
while True:
    ...
    if uart.any():
        ...
        slave_req_switchON  = data_rx.find("85AF4 255")
        slave_req_switchOFF = data_rx.find("85AF4 0")
        slave_req = data_rx.find("85AF4")
        if slave_req_switchON !=-1:
            ...
            uart.write("85AF4:" + "R1="+str(ChipTemp) + " ")
            time.sleep(0.02)
